...
import org.example.postapi.domain.image.exception.InvalidFileTypeException;
...
@RestController
@RequestMapping(ImageConstants.IMAGE_URL_PREFIX)
...
public class ImageController {
    ...
    public ResponseEntity<?> uploadImage(@AuthenticationPrincipal AuthUser user, final MultipartFile file) {
        ...
        String filename = ImageConstants.IMAGE_CACHE_NAME+"/"+ generateRandomFilename(user.getId().toString()) + getExtensionFromMimeType(file.getContentType());
